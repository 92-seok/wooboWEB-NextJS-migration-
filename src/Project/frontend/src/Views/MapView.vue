  ...
  <div class="d-flex flex-column">
    ...
    <div class="map_wrap">
      <div id="mapWrapper" style="width:50%;height:300px;float:left">
        ...
        <!--<div id="map" class="w-100 h-screen position-relative"></div>-->
...
var init_lat = 33.450701;
var init_lon = 126.570667;
var init_level = 1;
...
onUnmounted(() => {
  console.log("MapView.vue::unMounted()");
...
function loadMap() {
  ...
  kakao.maps.event.addListener(roadview, 'init', function () {
    console.log(`로드뷰 init 이벤트 발생 ${mapWalker}`);
    ...
    kakao.maps.event.addListener(roadview, 'viewpoint_changed', function () {
      console.log(`로드뷰 viewpoint_changed 이벤트 발생 ${mapWalker}`);
    ...
    kakao.maps.event.addListener(roadview, 'position_changed', function () {
      console.log(`로드뷰 position_changed 이벤트 발생 ${mapWalker}`);
